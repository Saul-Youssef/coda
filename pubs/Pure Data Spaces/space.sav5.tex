...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{end-garden.png}
...
\subsection{Is there a missing theory of morphisms?}
...
subspaces, ``outward facing'' morphisms between spaces have barely been touched.  We have done nothing to relate spaces with 
similar properties to each other.  
The situation may be analogous to understanding Set theory but not yet having a theory of categories where morphisms between similar spaces 
are understood in some coherent way.  One can expect a general theory of morphisms to exist, but it should also be substantially 
different than classical Category Theory, and so could possibly be a source of new insights.

\subsection{How is the rest of Mathematics supposed to work?}
...
with a semiring.  This appears to work well for the examples show here.  The ``organically grown'' 
spaces, the ``bespoke rationals'' and the spaces resulting from Seq functors are all well described as semirings and 
all have a similar algebraic flavor.  However, it is not clear how this is supposed to work for the parts of Mathematics 
which is far from the theory of semirings.

\subsection{Is there a deeper theory of spaces?}
...
and the theory of fields tells us about the bottom structure of spaces, but many classification questions remain.  Spaces are close 
to a number of known areas in mathematics which may provide insight.

\subsection{How can we effectively search for spaces, morphisms and proofs?}. 
...
\newblock {\em arXiv preprint arXiv:2305.05507}, 2023.
...
\bibitem{categories}
Robert Geroch.
\newblock {\em Mathematical Physics}.
...
\newblock {\em Bulletin of the American Mathematical Society}, 39(2):145--205, 2002.
