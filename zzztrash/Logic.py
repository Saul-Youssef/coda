...
#
#   A | B is the zen logical "or" of data A and B.
#
#   () | A -> ()
#   A  | () -> ()
#   A B | C -> (A|C) (B|C)
#   A | B C -> (A|B) (A|C)
#   a | b -> (a#b) if both a and b are atomic
#
#   demo: 1 | (null:a b c)
#   demo: 1 | (pass:a b c)
...
#    demo: implies () : x
#    demo: implies x : ()
#    demo: implies x : (foo:bar)
#    demo: implies (foo:bar) : x
#
def implies(A,B):
...
DEF.add(data(b'implies'),implies,implies_1,implies_2)
